			...
			<div class="right_col" role="main">
				<div class="">
					...
					<div class="container-fluid">
						<div class="row">
							<a class="btn btn-primary btn-sm" data-toggle="modal" href='#modal-tambahuser'><i class="fa fa-user-plus"></i> Tambah Pegawai</a>
								...
								<div class="modal-dialog modal-lg">
									<div class="modal-content">
										<div class="modal-header">
											...
											<h4 class="modal-title"><i class="fa fa-user-plus"></i> Tambah Pegawai</h4>
										</div>
										<div class="modal-body">
											<br />
											<form action="<?= base_url('pegawai/store'); ?>" enctype="multipart/form-data" method="post" class="form-horizontal form-label-left">
												<div class="form-group">
													<label class="control-label col-md-3 col-sm-3 col-xs-12" for="id_pegawai">ID Pegawai
													</label>
													<div class="col-md-6 col-sm-6 col-xs-12">
														<div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
															<input type="text" name="id_pegawai" id="id_pegawai" class="form-control col-md-7 col-xs-12" required placeholder="ID Pegawai" size="20">
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-6 col-sm-6 col-xs-12">
														<div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
															<input id="password" class="form-control col-md-7 col-xs-12" type="password" name="password" required placeholder="Password" size="30">
														</div>
													</div>
												</div>
												<div class="form-group">
							...
							<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%" style="font-size: 13px">
								...
								<tbody>
									...
									<tr>
										...
										<td><a href="<?= base_url('pegawai/show/'.$key->id_pegawai); ?>"><i class="fa fa-user"></i> <?= $key->nama; ?></a></td>
										<td><?= $key->jk; ?></td>
										<td><?= $key->tgl_lahir; ?></td>
										<td><?= $key->no_telp; ?>	</td>
										<td>
											<a href="<?= base_url(); ?>pegawai/show/<?= $key->id_pegawai ?>" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> Lihat</a>
											<a href="<?= base_url(); ?>pegawai/edit/<?= $key->id_pegawai ?>" class="btn btn-success btn-xs"><i class="fa fa-pencil"></i> Ubah</a>
											<a href="<?= base_url(); ?>pegawai/delete/<?= $key->id_pegawai ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Hapus</a>
										</td>
									</tr>
									<?php } ?>
								</tbody>
